...
return {
	...
	["nx|<leader>mm"] = map_callback(function()
		mc().addCursor()
	end):with_desc("MultiCursor: add cursor"),
	["nx|<leader>md"] = map_callback(function()
		mc().deleteCursor()
	end):with_desc("MultiCursor: delete cursor"),
	["n|<leader>mq"] = map_callback(function()
		mc().clearCursors()
	end):with_desc("MultiCursor: clear all"),
	["nx|<leader>me"] = map_callback(function()
		mc().enableCursors()
	end):with_desc("MultiCursor: enable editing"),
}
